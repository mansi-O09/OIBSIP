...
#==============variables================================
        ...
        self.combo_security_Q["values"]=("Select","Your Birth Place","Yur Bestie Name","Your Crush Name","Your Pet Name",)
        ...
        bl=Button(frame,image=self.photoimage1,borderwidth=0,cursor="hand2",font=("times new roman",15,"bold"))
